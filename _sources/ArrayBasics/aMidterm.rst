...
.. timed:: midterm1
   ...
   .. mchoice:: mt1_2
      ...
      :answer_e: 0 3 6 9 12
      :correct: d
      :feedback_a: This would be true if this loop had the correct syntax.  
      :feedback_b: The conditional would only take multiples of three, and the program does not output anything due to incorrect syntax.  
      :feedback_c: The conditional would only take multiples of three, and the program does not output anything due to incorrect syntax.  
      :feedback_d: The syntax to output text is System.out.print().  
      :feedback_e: The program would also output 15, since the loop runs until x <= 15. The program does not output anything due to incorrect syntax.
   ...
   .. mchoice:: mt1_4
      ...
      :correct: a
      :feedback_a: Correct!  
      :feedback_b: Option A is incorrect.  
      :feedback_c: Option A is incorrect.
      :feedback_d: Option A is incorrect.  
      :feedback_e: Option A is incorrect.  

      Which is NOT a correct method of declaring an array of integers with 5 elements?  
   ...
   .. mchoice:: mt1_5
      ...
      :feedback_b: While this name gives the user information about what the variable represents, it is too much and therefore should be shorter. 
      ...
      :feedback_e: Variable names can start with '_', '$', or a letter-- not '#'.

      What is the best name for an integer variable representing the number of students in a class?
   ...
   .. mchoice:: mt1_6
      ...
      :answer_e: Void 
      :correct: c
      :feedback_a: Class is a reserved keyword.  
      :feedback_b: Boolean is a reserved keyword and primitive data type.
   ...
   .. mchoice:: mt1_7
      ...
      :feedback_c: Incorrect. Remember that arrays are indexed from 0.
      :feedback_d: Incorrect. Remember that arrays are indexed from 0. 
   ...
   .. mchoice:: mt1_8
      ...
      :answer_e: A || !B
      :correct: c
      :feedback_a: This would evaluate as true in any case where A and B weren't both true
      :feedback_b: If B was false this option would evaluate to false.
      :feedback_c: Correct! 
      :feedback_d: This is the opposite and will evaluate to true only when both A and B are true.
      :feedback_e: This will evaluate as true if A is true, or B is false.

      Which option will evaluate to true only if both A and B are False
