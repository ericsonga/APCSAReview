...
project = u'Reivew of Java for AP CS A' # e.g. How To Think Like a Computer Scientist
copyright = u'2014 Barbara Ericson' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "Review of Java for AP CS A",
...
html_title = 'JavaReview'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='JavaReview'
...
htmlhelp_basename = 'JavaCoursewareProjectdoc'
